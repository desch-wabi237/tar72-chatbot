...
// 1. MODIFICATION: Nouveau nom de l'en-tête
...
// NOUVEAU LIEN: Veuillez remplacer cette URL par votre lien Melbet réel

const AFFILIATE_LINK_MELBET = "https://melbet.com/promo/TAR72"; 
    ...
    const formatMessageText = useCallback((text) => {
        ...
        return parts.map((part, index) => {
            ...
            if (part.startsWith(' https://') || part.startsWith('https://')) {
                ...
                // 4. MISE À JOUR: Vérifier les deux liens d'inscription

                if (url === AFFILIATE_LINK_1XBET) display = "Lien d'Inscription 1xBet 🚀";

                if (url === AFFILIATE_LINK_MELBET) display = "Lien d'Inscription Melbet 🎁";
        ...
        <div className="app-container">
            ...
            <style jsx="true">{`
                ...
                :root {
                    ...
                    --color-1xbet: #1d4ed8; /* Blue - pour 1xbet */

                    --color-melbet: #f59e0b; /* Orange/Yellow - pour Melbet */
                ...
                /* 2. MODIFICATION: Style pour le conteneur des deux boutons */
                ...
                .register-buttons-container {
                    ...
                    flex-shrink: 0; /* Empêche le rétrécissement sur petit écran */
                ...
                .register-button.xbet {
                    ...
                    background-color: var(--color-1xbet);
                ...
                .register-button.melbet {
                    ...
                    background-color: var(--color-melbet);
                ...
                @media (max-width: 768px) {
                    ...
                    .chat-header {
                        ...
                        /* 3. MODIFICATION: Permet aux boutons d'inscription de se réaligner si l'écran est très petit */
                    ...
                    .header-subtitle {
                        ...
                        /* Afficher l'essentiel du code promo sur mobile */
                    ...
                    /* 3. MODIFICATION: Assure que le bouton Envoyer et l'input s'adaptent bien */
                    ...
                    .chat-button {
                        ...
                        padding: 10px 18px; /* Bouton compact et facile à cliquer */
                    ...
                    .register-buttons-container {
                        ...
                        /* S'assure que le conteneur reste en ligne si possible, ou passe à la ligne */

                        min-width: 100%; /* S'assure qu'il prend toute la largeur si le wrap est actif */
            ...
            <div className="chat-card">
                ...
                <div className="chat-header">
                    ...
                    {/* 2. MODIFICATION: Deux boutons d'inscription */}
